...
class SugerenciaAdmin(admin.ModelAdmin):
    list_display = ['id','cedula','nombre', 'area', 'fecha','descripcion', 'responsable','estado', 'correo' ]
...
class QuejaAdmin(admin.ModelAdmin):
    list_display = ['id','cedula','nombre', 'area', 'Qfecha', 'Qresponsable', 'Qcausa', 'Qestado', 'correo' ]
...
class PeticionAdmin(admin.ModelAdmin):
    list_display = ['id','cedula','nombre', 'area', 'Pfecha', 'Presponsable', 'Pcausa', 'Pestado', 'correo' ]
...
class ReclamoAdmin(admin.ModelAdmin):
    list_display = ['id','cedula','nombre', 'area', 'Rfecha', 'Rresponsable', 'Rcausa', 'Restado', 'correo' ]
